...
private func makeMenuBarRecoveryDefaults() -> UserDefaults {
    let suiteName = "com.nehir.menubar.\(UUID().uuidString)"
...
@Suite struct StatusItemPersistenceRepairTests {
    @Test func appKitRestoreKeyContractUsesExpectedLiteralNames() {
        #expect(StatusItemPersistence.OwnedItem.main.autosaveName == "nehir_main")
        #expect(StatusItemPersistence.OwnedItem.hiddenBarSeparator.autosaveName == "nehir_hiddenbar_separator")
        #expect(preferredPositionKey(for: "nehir_main") == "NSStatusItem Preferred Position nehir_main")
        #expect(preferredPositionKey(for: "nehir_hiddenbar_separator") ==
            "NSStatusItem Preferred Position nehir_hiddenbar_separator")
        #expect(visibilityKeys(for: "nehir_main") == [
            "NSStatusItem Visible nehir_main",
            "NSStatusItem Visible Preference nehir_main",
            "NSStatusItem Visibility nehir_main"
        ])
        #expect(visibilityKeys(for: "nehir_hiddenbar_separator") == [
            "NSStatusItem Visible nehir_hiddenbar_separator",
            "NSStatusItem Visible Preference nehir_hiddenbar_separator",
            "NSStatusItem Visibility nehir_hiddenbar_separator"
        ])
    }
...
@Suite struct WorkspaceBarManagerPlacementTests {
    ...
    @Test func nonNotchedDisplaysKeepOverlappingPlacement() {
