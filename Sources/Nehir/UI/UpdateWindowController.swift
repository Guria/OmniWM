...
private struct UpdatePopupView: View {
    ...
    private var footer: some View {
        VStack(alignment: .leading, spacing: 12) {
            Text("Updates stay manual. Nehir can open the release page or copy the Homebrew upgrade command for you.")
                .font(.system(size: 12))
                .foregroundStyle(.secondary)
            ...
            HStack(spacing: 10) {
                ...
                Button(copiedCommand ? "Copied" : "Copy brew upgrade nehir") {
