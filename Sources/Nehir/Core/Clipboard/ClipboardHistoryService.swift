...
final class ClipboardPasteboardReader: @unchecked Sendable {
    private let queue = DispatchQueue(label: "com.nehir.clipboard-history.reader", qos: .utility)
...
enum ClipboardHistoryPasteboard {
    static let markerType = NSPasteboard.PasteboardType("org.nehir.clipboard-history")
    static let sourceType = NSPasteboard.PasteboardType("org.nehir.clipboard-source")
